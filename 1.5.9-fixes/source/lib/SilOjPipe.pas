...
type
  SilNamedPipe = class(Tool)
    class function Create(
          ...
          const TimeOut: LongWord = INFINITE): INamedPipeServer; virtual; abstract;
    class function Open(
          const Name: String;
          const Access: TPipeAccess;
          const PipeType: TPipeMode = pmStream;
          const ReadMode: TPipeMode = pmStream): INamedPipeClient; virtual; abstract;
  end;
