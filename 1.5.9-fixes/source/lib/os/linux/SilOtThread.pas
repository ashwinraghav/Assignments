...
class function LinuxThread.List: IThreadList;
begin
  Result := SilOfThreadList.GetList;
end;

class function LinuxThread.ID: LongWord;
begin
  Result := SilOfThread.GetCurrentId;
end;

class function LinuxThread.IsMain: Boolean;
begin
  Result := SilOfThread.GetCurrentId = SilOfThread.MainThreadID;
end;

class procedure LinuxThread.AsyncCall(Method: TThreadCallMethod; const Obj: IInterface; Param: Pointer);
begin
  SilOfThreadList.GetList.ThreadCall(Obj, tcAsync, Method, Param);
end;

class procedure LinuxThread.AsyncCall(Method: TThreadCallMethod);
begin
  SilOfThreadList.GetList.ThreadCall(nil, tcAsync, Method, nil);
end;

class procedure LinuxThread.AsyncCall(Method: TThreadCallMethod; const Param: Pointer);
begin
  SilOfThreadList.GetList.ThreadCall(nil, tcAsync, Method, Param);
end;

class procedure LinuxThread.SyncCall(Method: TThreadCallMethod; const Obj: IInterface; Param: Pointer);
begin
  SilOfThreadList.GetList.ThreadCall(Obj, tcSync, Method, Param);
end;

class procedure LinuxThread.SyncCall(Method: TThreadCallMethod);
begin
  SilOfThreadList.GetList.ThreadCall(nil, tcSync, Method, nil);
end;

class procedure LinuxThread.SyncCall(Method: TThreadCallMethod; const Param: Pointer);
begin
