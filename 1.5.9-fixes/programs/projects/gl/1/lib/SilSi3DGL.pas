...
type
  ...
  I3dgObjectBuilder = interface
    ...
    procedure Square(const Position: R3DPoint; const Delta: R3DVector; AColor: TGLColor; Orientation: Integer = +1);
    procedure Apply;
  end;
